...
const CleaningManagementPage = () => {
  ...
  const exportExcel = () => {
    ...
    worksheet['!cols'] = [{ wch: 24 }, { wch: 18 }, { wch: 14 }, { wch: 16 }, { wch: 18 }, { wch: 36 }];
