                    ...
                    return (
                      <tr key={route._id} className="hover:bg-amber-50/20 transition-colors group">
                        ...
                        <td className="py-3.5 px-4">
                          <span className="font-extrabold text-slate-900 text-sm font-mono bg-slate-100 px-2 py-1 rounded">
                            {route.serviceId}
                          </span>
                        </td>
                        ...
                        <td className="py-3.5 px-4">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-slate-900 text-sm">{route.fromCity}</span>
                            <ArrowRight className="w-3 h-3 text-slate-400 shrink-0" />
                            <span className="font-bold text-slate-900 text-sm">{route.toCity}</span>
                          </div>
                          {route.notes && (
                            <div className="text-[11px] text-slate-400 mt-0.5 truncate max-w-[200px]" title={route.notes}>
                              {route.notes}
                            </div>
                          )}
                        </td>
                        ...
                        <td className="py-3.5 px-4 whitespace-nowrap">
                          <span className={`px-2 py-1 rounded-md text-[11px] font-bold ${
                            route.type === 'Full Sleeper' ? 'bg-indigo-50 text-indigo-700' : 'bg-cyan-50 text-cyan-700'
                          }`}>
                            {route.type || 'Full Sleeper'}
                          </span>
                        </td>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="sm:col-span-2">
                  ...
                  <div className="relative">
                    <Compass className="w-4 h-4 text-indigo-600 absolute left-3 top-3" />
                    <input
                      type="text"
                      required
                      placeholder="e.g. SRY-001"
