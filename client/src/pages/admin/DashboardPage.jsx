                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setEmpFormData({ ...empFormData, experience: e.target.value === '' ? '' : Number(e.target.value) })}
                      className="w-full px-3.5 py-2.5 pr-16 rounded-xl border border-slate-300 text-xs sm:text-sm focus:outline-none focus:border-amber-500"
                    />
