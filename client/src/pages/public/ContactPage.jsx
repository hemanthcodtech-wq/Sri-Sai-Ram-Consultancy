        ...
        <div className="max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 space-y-5 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-3 sm:grid-cols-3 gap-3">
            ...
            <ScrollReveal direction="up" delay={0} duration={600}>
              <a
                href={`tel:${phoneRaw}`}
                className="flex items-center gap-3 bg-white rounded-2xl p-3.5 sm:p-5 border-2 border-blue-100 hover:border-blue-400 shadow-sm hover:shadow-md transition-all group h-full"
              >
            ...
            <ScrollReveal direction="up" delay={150} duration={600}>
              <a
                ...
                className="flex items-center gap-3 bg-white rounded-2xl p-3.5 sm:p-5 border-2 border-emerald-100 hover:border-emerald-400 shadow-sm hover:shadow-md transition-all group h-full"
              >
            ...
            <ScrollReveal direction="up" delay={300} duration={600}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-white rounded-2xl p-3.5 sm:p-5 border-2 border-amber-100 hover:border-amber-400 shadow-sm hover:shadow-md transition-all group h-full"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-stretch">
            ...
            {/* Office Info */}
            <ScrollReveal direction="left" delay={100} duration={650} className="h-full">
              <div className="bg-[#081C36] rounded-2xl p-5 sm:p-7 text-white border border-amber-400/20 shadow-lg flex flex-col justify-between gap-4 h-full">
                <div>
            ...
            <ScrollReveal direction="right" delay={150} duration={650} className="h-full">
              <div className="bg-white rounded-2xl p-5 sm:p-7 shadow-lg border border-slate-200 flex flex-col gap-4 h-full">
                <div>
